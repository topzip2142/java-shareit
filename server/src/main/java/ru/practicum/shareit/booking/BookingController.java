...
public class BookingController {
    ...
    @PostMapping
    public BookingResponseDTO createBooking(@RequestHeader(REQUEST_HEADER_USER_ID) long userId,
    ...
    @GetMapping("/owner")
    public Collection<BookingResponseDTO> getAllBookingsByOwner(@RequestHeader("X-Sharer-User-Id") long userId,
                                                        @RequestParam(defaultValue = "ALL") String state) {
